...
import (
	...
	"github.com/leyl1ne/LocalFarmersMarket/pkg/logger/sl"
	"github.com/leyl1ne/LocalFarmersMarket/services/sso/internal/domain/models"
	"github.com/leyl1ne/LocalFarmersMarket/services/sso/internal/lib/jwt"
...
type UserSaver interface {
	SaveUser(ctx context.Context,
		...
		farmName string,
		address models.Address) (uid int64, err error)
}
...
func (a *Auth) RegisterNewUser(ctx context.Context,
	...
	role models.UserRole,
	farmName string,
	address models.Address) (int64, error) {
	...
	// сохраняем пользователся в бд
	id, err := a.usrSaver.SaveUser(ctx, email, username, passHash, phone, role, farmName, address)
	if err != nil {
